...
<?php } 
$estado=select("*","estados","","ID ASC LIMIT 1, 32");
?>
...
<head>
    ...
    <main class="page">
        ...
        <div class="container">
            <!--Inicia Container-->
            <form role="form" name="registroEmp">
                <div class="row">
                    <div class="col-md-12">
                        <p>&nbsp;</p>

                        <h3 align="center">Registro para el Diplomado en Seguros para instituciones que tienen
                            convenio</h3>
                        ...
                        <div class="contenedor_registro">
                            ...
                            <div class="tooltip-container col-md-3">
                            ...
                            <div class="tooltip-container col-md-6">
                                <label class="control-label" for="text">Grupo:</label>
                                <i class="fas fa-question-circle tooltip-trigger"></i>
                                <div class="tooltip-one">
                                    Institución a la que te inscribiras
                                </div>
                            ...
                            <div class="tooltip-container col-md-6">
                                ...
                                <i class="fas fa-question-circle tooltip-trigger"></i>
                                <div class="tooltip-one"> Revisa bien que el correo electrónico sea correcto, ya que
                                    este se utilizará para enviarte información al respecto</div>
                            ...
                            <div class="tooltip-container col-md-3">
                                ...
                                <select name="sexo" id="sexo" class="form-control">
                                    ...
                                    <option value="P/E">Prefiero no especificar</option>
                                </select>
                            </div>
                            ...
                            <?php $generacion=select("id_generacion","generaciones","estatus=1",""); ?>
                            <?php 
                        ...
                        <div class="form-group">
                            ...
                            <strong>Nota: Tu usuario será el correo electrónico que registraste.</trong><br><br>
                                <strong>He leído el Aviso de Privacidad. </strong><a
                                    href="documentos/AvisoPrivacidadIntegralDiplomadoEF-2022.pdf" target="_blank"
        ...
        function fenvia() {
            ...
            if (document.getElementById("estado").selectedIndex == 0) {
                ...
                document.getElementById("msg").style.visibility = "visible";
                document.getElementById("msg").innerHTML = "Elige un estado";
                return false;
            }
            ...
            if (tamanio_tel < 10 || tamanio_tel > 20) {
                ...
                document.getElementById("msg").innerHTML =
                    "El campo teléfono debe ser mínimo de 10 digitos y máximo 20";
                return false;
            }
            ...
            if (document.getElementById("aspirante").value == "") {
                ...
                document.getElementById("msg").style.visibility = "visible";
                document.getElementById("msg").innerHTML = "Escribe el número de empleado o de matrícula";
                return false;
            }
            ...
            form.action = "registro_convenio.php";
            form.method = "post";
            form.submit();
        }
    ...
    <!--<iframe frameborder="0" height="0" src=https://phpapps.condusef.gob.mx/soldiploma/dip_lanzaRegistro.php?id=<?php echo $idAlumno?> width="100%"></iframe>-->