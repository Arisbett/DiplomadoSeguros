...
$actividad3=select('a.nombre ','actividades a','a.id_actividad=18','','');
...
$respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_actividad=18');
$contador=1;
?>
...
<div class="container">
    ...
    <div class="col-md-6">
            <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=92');
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=93');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=94');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=95');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=96');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
    ...
    <p class="pull-left">    
        ...
        <button class="btn btn-default" type="button" onClick="document.location.href='modulo3.php?p=3'">Regresar</button>
...
if ($_POST) { 
 ...
 if (count($mr1)>=1) {
     update("actividad_modulo3","actividad7=1 ","actividad_modulo3.id_alumno = $idAl AND actividad_modulo3.id_generacion = $idGen","");
 }else{
 insert("actividad_modulo3","id_alumno, actividad7, id_generacion","'$idAl', '1', '$idGen'");
 }  
