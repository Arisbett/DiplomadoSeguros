...
?>
            ...
            <form role="form" name="actividad4">
                <div class="form-group pregunta1">
                    <?php
                             $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=1');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=1');?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta2">
                    <?php
                             $pregunta2=select('pregunta','actividades_preguntas','id_actividad_preguntas=2');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=2');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta3">
                    <?php
                             $pregunta3=select('pregunta','actividades_preguntas','id_actividad_preguntas=3');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=3');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta4">
                    <?php
                             $pregunta4=select('pregunta','actividades_preguntas','id_actividad_preguntas=4');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=4');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta5">
                    <?php
                             $pregunta5=select('pregunta','actividades_preguntas','id_actividad_preguntas=5');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=5');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                        ...
                        <div class="col-sm-offset-2 col-sm-10">
                            <p class="pull-right">
                                ...
                                <button class="btn btn-default" type="button"
                                    onClick="document.location.href='modulo1.php?p=2'">Regresar</button>
           ...
           if ($_POST) { 
            ...
            if (count($mr1)>=1) {
                update("actividad_modulo1","actividad1=1 ","actividad_modulo1.id_alumno = $idAl AND actividad_modulo1.id_generacion = $idGen","");
            }else{
            insert("actividad_modulo1","id_alumno, actividad1, id_generacion","'$idAl', '1', '$idGen'");
            } 
        }?>
<?php
