...
if($_POST["correo"] != $_POST["correo2"]) {
    ...
    if ($total == 1) {
      ...
      $query = Conexion::conectar()->prepare("INSERT INTO alumno(nombre, apaterno, amaterno, pass, genero, edad, correo, telefono, id_estado, id_grupo, id_generacion, autorizacion, informacion, ocupacion, nivel_Estudios)
                                              VALUES (:nom, :apat, :amat,  :pass,:sex,:edad,:correo,:tel,  :estado,  :idGrupo, :gen, :aut,  :info, :ocupacion, :nivel)" );
      ...
      $query->bindParam(':ocupacion', $ocupacion, PDO::PARAM_STR);
