...
?>
            ...
            <form role="form" name="actividad4">
                <div class="form-group pregunta1">
                    <?php
                             $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=58');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=58');?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta2">
                    <?php
                             $pregunta2=select('pregunta','actividades_preguntas','id_actividad_preguntas=59');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=59');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta3">
                    <?php
                             $pregunta3=select('pregunta','actividades_preguntas','id_actividad_preguntas=60');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=60');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta4">
                    <?php
                             $pregunta4=select('pregunta','actividades_preguntas','id_actividad_preguntas=61');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=61');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta5">
                    <?php
                             $pregunta5=select('pregunta','actividades_preguntas','id_actividad_preguntas=62');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=62');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
           ...
           if ($_POST) { 
            ...
            if (count($mr1)>=1) {
                update("actividad_modulo3","actividad1=1 ","actividad_modulo3.id_alumno = $idAl AND actividad_modulo3.id_generacion = $idGen","");
            }else{
            insert("actividad_modulo3","id_alumno, actividad1, id_generacion","'$idAl', '1', '$idGen'");
            } 
        }?>
<?php
