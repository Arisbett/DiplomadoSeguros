...
?>
            ...
            <form role="form" name="actividad4">
                <div class="form-group pregunta1">
                    <?php
                             $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=97');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=97','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta2">
                    <?php
                             $pregunta2=select('pregunta','actividades_preguntas','id_actividad_preguntas=98');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=98','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta3">
                    <?php
                             $pregunta3=select('pregunta','actividades_preguntas','id_actividad_preguntas=99');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=99','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta4">
                    <?php
                             $pregunta4=select('pregunta','actividades_preguntas','id_actividad_preguntas=100');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=100','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta5">
                    <?php
                             $pregunta5=select('pregunta','actividades_preguntas','id_actividad_preguntas=101');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=101','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta6">
                    <?php
                             $pregunta5=select('pregunta','actividades_preguntas','id_actividad_preguntas=102');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=102','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                        ...
                        <div class="col-sm-offset-2 col-sm-10">
                            <p class="pull-right">
                                ...
                                <button class="btn btn-default" type="button"
                                    onClick="document.location.href='modulo3.php?p=4'">Regresar</button>
           ...
           if ($_POST) { 
            ...
            if (count($mr1)>=1) {
                update("actividad_modulo3","actividad8=1 ","actividad_modulo3.id_alumno = $idAl AND actividad_modulo3.id_generacion = $idGen","");
            }else{
            insert("actividad_modulo3","id_alumno, actividad8, id_generacion","'$idAl', '1', '$idGen'");
            }  
