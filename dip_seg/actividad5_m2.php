...
$actividad3=select('a.nombre ','actividades a','a.id_actividad=10 ','','');
...
$respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_actividad=10');
$contador=1;
?>
...
<div class="container">
    ...
    <div class="col-md-6">
            <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=53');
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=54');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=55');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=56');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=57');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
...
<br><br><br>
    ...
    <p class="pull-left">    
        ...
        <button class="btn btn-default" type="button" onClick="document.location.href='modulo3.php?p=1'">Regresar</button>
...
if ($_POST) { 
 ...
 $idAl=$_SESSION["idAlumno"];
            ...
            if (count($mr1)>=1) {
                update("actividad_modulo2","actividad5=1 ","actividad_modulo2.id_alumno = $idAl AND actividad_modulo2.id_generacion = $idGen","");
            }else{
            insert("actividad_modulo2","id_alumno, actividad5, id_generacion","'$idAl', '1', '$idGen'");
            } 
