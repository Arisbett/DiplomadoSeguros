...
foreach ($actividad1 as $var) {
    if($id_act==0 ||  $id_act != $row["id_actividad"]){
        echo "<h3>".$var["nombre"]."</h3> <br>  <p>Instrucciones: En las siguientes afirmaciones en materia de sanas prácticas, transparencia y publicidad, selecciona la opción SI para aquellas que son correctas y la opción NO para aquellas incorrectas.</p>";
...
?>
            ...
            <form role="form" name="actividad4">
                <div class="form-group pregunta1">
                    <?php
                             $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=43');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=43');?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta2">
                    <?php
                             $pregunta2=select('pregunta','actividades_preguntas','id_actividad_preguntas=44');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=44');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta3">
                    <?php
                             $pregunta3=select('pregunta','actividades_preguntas','id_actividad_preguntas=45');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=45');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta4">
                    <?php
                             $pregunta4=select('pregunta','actividades_preguntas','id_actividad_preguntas=46');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=46');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta5">
                    <?php
                             $pregunta5=select('pregunta','actividades_preguntas','id_actividad_preguntas=47');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=47');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta6">
                    <?php
                             $pregunta6=select('pregunta','actividades_preguntas','id_actividad_preguntas=48');
                             foreach($pregunta6 as $row6){ ?>
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=48');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta7">
                    <?php
                             $pregunta7=select('pregunta','actividades_preguntas','id_actividad_preguntas=49');
                             foreach($pregunta7 as $row7){ ?>
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=49');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta8">
                    <?php
                             $pregunta8=select('pregunta','actividades_preguntas','id_actividad_preguntas=50');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=50');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta9">
                    <?php
                             $pregunta9=select('pregunta','actividades_preguntas','id_actividad_preguntas=51');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=51');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta10">
                    <?php
                             $pregunta10=select('pregunta','actividades_preguntas','id_actividad_preguntas=52');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=52');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
            ...
            function fenvia() {
                ...
                if (!document.getElementById('r8_0').checked && !document.getElementById('r8_1').checked) {
                ...
                if (!document.getElementById('r9_0').checked && !document.getElementById('r9_1').checked) {
                ...
                if (!document.getElementById('r10_0').checked && !document.getElementById('r10_1').checked) {
           ...
           if ($_POST) { 
            ...
            if (count($mr1)>=1) {
                update("actividad_modulo2","actividad4=1 ","actividad_modulo2.id_alumno = $idAl AND actividad_modulo2.id_generacion = $idGen","");
            }else{
            insert("actividad_modulo2","id_alumno, actividad4, id_generacion","'$idAl', '1', '$idGen'");
            } 
        }?>
<?php
