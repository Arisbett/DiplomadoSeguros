...
if($_POST["correo"] != $_POST["correo2"]) {
    ...
    if ($total == 1) {
      ...
      $query = Conexion::conectar()->prepare("INSERT INTO alumno(nombre, apaterno, amaterno, pass, genero, edad, correo, telefono, matricula, id_estado, id_grupo, id_generacion, autorizacion, informacion, nivel_Estudios, tipo_aspirante)
                                              VALUES (:nom, :apat, :amat,  :pass,:sex,:edad,:correo,:tel, :numeroE, :estado,  :idGrupo, :gen, :aut,  :info,:nivel, :aspirante)" );
