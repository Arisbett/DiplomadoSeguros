...
<?php include("include/menu-modulo.php");
 ...
 $mod1=$con->query("SELECT modulo, objetivo FROM modulo  WHERE id_modulo=4 ");
 $mod1->execute();
...
<?php } ?>
 ...
 $mod1t=$con->query("SELECT capitulo FROM capitulo WHERE id_modulo=4 and estatus=1 ");
 $mod1t->execute();
...
?> 
                ...
                <div class="tab-pane <?=($p==1?"active in":"")?>" id="tab-01">
                    <!------>
                    <?php include("contenidos_mod/contenido1_m4.php");?>
                </div>
                <div class="tab-pane <?=($p==2?"active in":"")?>" id="tab-02">
                    <!------>
                    <?php include("contenidos_mod/contenido2_m4.php");?>
                ...
                <div class="tab-pane <?=($p==3?"active in":"")?>" id="tab-03">
                    <!------>
                    <?php include("contenidos_mod/contenido3_m4.php");?>
                   <!-- <center><button class="btn btn-primary btn-lg active" type="button">Actividad 2</button></center>
                    ---->  
                </div>
     ...
     if (count($resultadoEF)<4 && $cal <=69)  {
         echo '<center><a href="examen_m4.php" class="btn btn-primary ">EVALUACIÓN</a></center>'; 
