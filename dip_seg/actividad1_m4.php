...
$actividad3=select('a.nombre ','actividades a','a.id_actividad=22 ','','');
...
$respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_actividad=22');
$contador=1;
?>
...
<div class="container">
    ...
    <div class="col-md-6">
            <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=110');
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=111');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=112');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=113');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=114');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
    ...
    <p class="pull-left">    
        ...
        <button class="btn btn-default" type="button" onClick="document.location.href='modulo4.php?p=2'">Regresar</button>
...
if ($_POST) { 
 ...
 if (count($mr1)>=1) {
     update("actividad_modulo4","actividad1=1 ","actividad_modulo4.id_alumno = $idAl AND actividad_modulo4.id_generacion = $idGen","");
 }else{
 insert("actividad_modulo4","id_alumno, actividad1, id_generacion","'$idAl', '1', '$idGen'");
 } 
