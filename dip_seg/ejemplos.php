...
if ($total_bien==15) {
    echo "<div>&nbsp;</div><div>&nbsp;</div><div class=\"alert alert-info\"><b>Tienes " .$total_bien." respuestas correctas de 15 preguntas.<br> Obtuviste el $calEx % de la calificación final</b></div>";
