...
<main class="page">
    ...
    <div class="container">
        ...
        <form role="form" name="form1">
            <div class="row">
                <div class="col-md-12">
                    <p>&nbsp;</p>
                    <h3 align="center">Registro para el Diplomado en Seguros para público en general</h3>
                    ...
                    <div class="contenedor_registro">
                        ...
                        <?php $grupo=select("id_grupo","grupo", "id_grupo=1",""); 
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="checkboxcol-md-12" align="center">
                            ...
                            <strong>Nota: Tu usuario de acceso será tu correo electrónico</trong><br><br>
    ...
    function fenvia() {
        ...
        document.getElementById("msg").style.visibility = "visible";
        document.getElementById("msg").innerHTML = "Elige una opción en el campo ocupacion";
        return false;
        }
        ...
        document.getElementById("msg").style.visibility = "visible";
        document.getElementById("msg").innerHTML = "Elige una opción en el campo nivel";
        return false;
        }
