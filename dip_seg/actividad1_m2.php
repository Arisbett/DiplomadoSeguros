...
?>
            ...
            <form role="form" name="actividad4">
                <div class="form-group pregunta1">
                    <?php
                             $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=27');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=27','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                ...
                <div class="form-group pregunta2">
                    <?php
                             $pregunta2=select('pregunta','actividades_preguntas','id_actividad_preguntas=28');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=28','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta3">
                    <?php
                             $pregunta3=select('pregunta','actividades_preguntas','id_actividad_preguntas=29');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=29','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta4">
                    <?php
                             $pregunta4=select('pregunta','actividades_preguntas','id_actividad_preguntas=30');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=30','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta5">
                    <?php
                             $pregunta5=select('pregunta','actividades_preguntas','id_actividad_preguntas=31');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=31','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta6">
                    <?php
                             $pregunta5=select('pregunta','actividades_preguntas','id_actividad_preguntas=32');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=32','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
                ...
                <div class="form-group pregunta7">
                    <?php
                             $pregunta5=select('pregunta','actividades_preguntas','id_actividad_preguntas=33');
                    ...
                    <div class="checkbox">
                        <label class="radio-inline">
                            <?php
                               $respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_pregunta=33','id_actividad_opciones ASC');?>
                            <?php   $i=0;
                                       foreach($respuesta as $row){
                                            ?>
           ...
           if ($_POST) { 
            ...
            if (count($mr1)>=1) {
                update("actividad_modulo2","actividad1=1 ","actividad_modulo2.id_alumno = $idAl AND actividad_modulo2.id_generacion = $idGen","");
            }else{
            insert("actividad_modulo2","id_alumno, actividad1, id_generacion","'$idAl', '1', '$idGen'");
            } 
        }?>
<?php
