...
if ($total_bien==15) {
    ...
    echo '<a href="modulo4.php?p=1" class="btn btn-primary ">Regresar</a><br>';
...
$query = Conexion::conectar()->prepare("INSERT INTO examen_m4 (idAlumno,$camposr,$camposp,Calificacion_R,Calificacion_Final,idGeneracion) VALUES (:idAl, $valoresr,$valoresp, :cal,:caltot, :idGen)");
