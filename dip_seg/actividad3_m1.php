...
$actividad3=select('a.nombre ','actividades a','a.id_actividad=3 ','','');
...
$respuesta=select('opcion, id_actividad_opciones','actividades_opciones','id_actividad=3');
$contador=1;
?>
...
<div class="container">
    ...
    <div class="col-md-6">
            <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=11');
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=12');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=13');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=14');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=15');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=16');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=17');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        ...
        <?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad_preguntas=18');
                foreach($pregunta as $row){
            ?>
        <div class="pregunta<?php echo $contador; ?>">
        <div class="col-md-2" id="r8_evalua"></div>
            <p> <b> <?php echo $row["pregunta"]; }?></b></p>
            <span id="asterisco_r8" class="form-text"><input class="form-control" id="r8" name="r8" placeholder="*" type="text"><div id="err_asterisco_r8"></div>
        </div>
    ...
    <p class="pull-left">    
        ...
        <button class="btn btn-default" type="button" onClick="document.location.href='modulo1.php?p=4'">Regresar</button>
...
if ($r8 == '2') {
    echo "<script> document.getElementById('r8_evalua').innerHTML ='<div class=\"alert alert-success\"><img src=\"image/imag/palomita.png\" width=\"30\"  /></div>';</script>";
}else{
    echo "<script> document.getElementById('r8_evalua').innerHTML ='<div class=\"alert alert-success\"><img src=\"image/imag/tache.png\" width=\"30\"  /></div>';</script>";
...
$idAl=$_SESSION["idAlumno"];
            ...
            if (count($mr1)>=1) {
                update("actividad_modulo1","actividad3=1 ","actividad_modulo1.id_alumno = $idAl AND actividad_modulo1.id_generacion = $idGen","");
            }else{
            insert("actividad_modulo1","id_alumno, actividad3, id_generacion","'$idAl', '1', '$idGen'");
            } 
