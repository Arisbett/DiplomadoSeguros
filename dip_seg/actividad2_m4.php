...
<div class="col-md-6">
<?php
                $pregunta=select('pregunta','actividades_preguntas','id_actividad=23');
   ...
   <a href="modulo4.php?p=3"> <button type="button" class="btn btn-primary">Regresar</button></a>
   ...
   <?php 
    ...
    if (count($mr1)>=1) {
        update("actividad_modulo4","actividad2=1 ","actividad_modulo4.id_alumno = $idAl AND actividad_modulo4.id_generacion = $idGen","");
    }else{
    insert("actividad_modulo4","id_alumno, actividad2, id_generacion","'$idAl', '1', '$idGen'");
    } 
   ?>
    ...
    <script>
        ...
        var palabras = ['gastosmedicos','conciliacion','resba','sipres','recas','reune','arbitraje', 'reclamacion'
        ];
