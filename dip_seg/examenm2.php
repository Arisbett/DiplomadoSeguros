...
if ($total_bien==15) {
    ...
    echo '<a href="modulo2.php?p=1" class="btn btn-primary ">Regresar</a><br>';
 } else{
    echo "<div>&nbsp;</div><div>&nbsp;</div><div class=\"alert alert-info\"><b>Tienes " .$total_bien." respuestas correctas de 15 preguntas.<br></b></div>";
    echo '<a href="modulo2.php?p=1" class="btn btn-primary ">Regresar</a><br>';                      
}
...
// echo "INSERT INTO examen_m1 (idAlumno,$camposr,$camposp,Calificacion,idGeneracion) VALUES (:idAl, $valoresr,$valoresp, :cal, :idGen)";
$query = Conexion::conectar()->prepare("INSERT INTO examen_m2 (idAlumno,$camposr,$camposp,Calificacion_R,Calificacion_Final,idGeneracion) VALUES (:idAl, $valoresr,$valoresp, :cal,:caltot, :idGen)");
